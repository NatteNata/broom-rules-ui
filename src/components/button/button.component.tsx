    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === 'primary' &&
            'bg-accent-500 text-light-100 hover:bg-100 active:bg-accent-700 active:text-light-500 focus:bg-accent-500 focus:border-accent-700 focus:border-2 disabled:bg-accent-900 disabled:text-light-900',
          variant === 'secondary' &&
          ...
          variant === 'outlined' &&
            'border border-accent-500 text-accent-500 hover:text-accent-100 hover:border-accent-100 active:text-accent     -700 active:border-accent-700 active:border focus:border-2 focus:text-accent-700 focus:border-accent-700 disabled:text-accent-900 disabled:border-accent-900',
          variant === 'ghost' &&
