...
const meta: Meta<typeof Card> = {
  argTypes: {
    asElement: {
      ...
      description: 'Changes semantic selectors in HTML, keeping the same appearance',
    ...
    children: {
      ...
      description: 'Size depends on the cize of children. Editable text controls',
    },
    ref: {
      table: {
        disable: true,
...
export const WithSetSizes: Story = {
  args: {
    style: { color: '#8d9094', height: '200px', padding: '12px', width: '200px' },
  },
